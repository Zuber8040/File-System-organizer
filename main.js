...
function organizeFn(dirPath){
    ...
    // step 1: input->directory path given 
    ...
    let destPath;
        if(dirPath==undefined){
          ...
          if(doesExit){
                  // step 2 : create-> organized_files  -> directory 
...
function organizeHelper(src,dest){
    ...
    for(let i=0;i<childNames.length;i++){
       ...
       if(isFile){
            ...
            // step 4: copy/cut files to that organized directory inside of any of category folder
